...
!based on regression modsi vs. gbbepx fix modis emissions and
!use co emissions to calculate frp 

PROGRAM convert_fix_modis
...
!from regression over 3 months for .995 ordered points
  REAL, PARAMETER :: fixfrp=2698.2e8, fix_co=1./745.0e8, fix_bc=1./2.6e8,&
       &fix_oc=1./2.1e8,fix_pm_25=1./0.6e8, fix_so2=1./146.3e8
