...
!derive frp values from eco and scaling of 2.7e11 based on average
!ratio over tiles

PROGRAM convert_gbbepx_fixfrp
...
END PROGRAM convert_gbbepx_fixfrp
