...
def aws_viirs_list(start, end):
    ...
    for date in date_generated:
        ...
        #day_files = aws.ls('noaa-jpss/SNPP/VIIRS/SNPP_Aerosol_Optical_Depth_Reprocessed/' + year + '/' + month + '/' + day + '/', refresh=True)
        #day_files = aws.ls('noaa-jpss/SNPP/VIIRS/SNPP_VIIRS_Aerosol_Detection_EDR_Reprocessed/' + year + '/' + month + '/' + day + '/', refresh=True)
	### Match day_files to be consisetnt with  https://noaa-jpss.s3.amazonaws.com/index.html
	#2020 and before
        day_files = aws.ls('noaa-jpss/SNPP/VIIRS/SNPP_VIIRS_Aerosol_Optical_Depth_EDR_Reprocessed/' + year + '/' + month + '/' + day + '/', refresh=True)
	#NRT
        #day_files = aws.ls('noaa-jpss/SNPP/VIIRS/SNPP_VIIRS_Aerosol_Optical_Depth_EDR/' + year + '/' + month + '/' + day + '/', refresh=True)
