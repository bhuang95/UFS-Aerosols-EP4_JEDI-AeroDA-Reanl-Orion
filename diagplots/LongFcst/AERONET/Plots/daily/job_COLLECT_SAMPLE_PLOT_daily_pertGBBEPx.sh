...
for EXP in ${EXPS}; do
    TOPDIAGDIR=${TOPEXPDIR}/${EXP}/diagplots/LongFcst/AERONET-pertGBBEPx/${AODTYPE}
...
while [ ${CDATE} -le ${EDATE} ]; do
    ...
    CD=${CDATE:6:2}
    CH=${CDATE:8:2}
    INDIR=${TOPEXPDIR}/${EXP}/dr-data-longfcst-pertgbbepx-backup/gdas.${CY}${CM}${CD}/${CH}/diag/aod_obs
