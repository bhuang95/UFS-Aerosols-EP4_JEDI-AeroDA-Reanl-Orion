...
for EXP in ${EXPS}; do
    TOPDIAGDIR=${TOPEXPDIR}/${EXP}/diagplots/LongFcst/AERONET-fixedGBBEPx/${AODTYPE}
...
while [ ${CDATE} -le ${EDATE} ]; do
    ...
    CD=${CDATE:6:2}
    CH=${CDATE:8:2}
    INDIR=${TOPEXPDIR}/${EXP}/dr-data-longfcst-fixedgbbepx-backup/gdas.${CY}${CM}${CD}/${CH}/diag/aod_obs
