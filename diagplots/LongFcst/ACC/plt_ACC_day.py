...
#	'RET_EP4_AeroDA_YesSPEEnKF_YesSfcanl_v15_0dz0dp_41M_C96_202006'
    ...
    ylab="ACC"
    xtinc=2
    pstr=f'{expdate}_ACC_6hours'
    ypert= 0
    ylim=0
    pp=plot_line(data, plegs, pcols, plines, pmarks, xarr, xlab, ylab, ypert, pstr, xtinc, ylim)
    ...
    for exprun in expruns:
        ncfile=f'{datadir}/acc_{exprun}.nc'
        ncind=open_ncfile(ncfile)
        data1d=ncind.variables['ACCDailyMean'][:]
        ncind.close()
        data2d.append(data1d)
    arr2d = np.array(data2d)
