...
def plot_line(data, plegs, pcols, plines, pmarks, xarr, xlab, ylab, ypert, pstr, xtickinc):
    tfsize=14
    lfsize=14
...
if __name__ == '__main__':
   ...
   # datadir='/scratch2/BMC/gsd-fv3-dev/MAPP_2018/bhuang/JEDI-2020/JEDI-FV3/conferencePlots/202401AMS/LongFcst/ACC/data'
    ...
    datadir='/scratch1/BMC/gsd-fv3-dev/MAPP_2018/pagowski/R/outdata_acc_new'
    expruns=[
...
#	'RET_EP4_AeroDA_YesSPEEnKF_YesSfcanl_v15_0dz0dp_41M_C96_202006'
    ...
    pstr="ACC_6hours"
    ypert= 0
    pp=plot_line(data, plegs, pcols, plines, pmarks, xarr, xlab, ylab, ypert, pstr, xtinc)

    data=np.zeros((3, 5))
    for i in range(5):
        ist=i*4+1
        ied=(i+1)*4
        data[:,i]=np.mean(arr2d[:,ist:ied], axis=1)
